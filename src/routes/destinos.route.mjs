...
import { createDestino, getAllDestino, getDestinoByid, getDestinosPorIdServicio, removeDestinoByid, updateProductById } from '../controllers/destinos.cotroller.mjs';
